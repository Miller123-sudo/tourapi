...
exports.forgotPassword = exports.updatePassword = exports.signup = exports.logout = exports.login = void 0;
...
var signup = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(name, email, role, password, confirmPassword) {
    var res;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (res.data.status == 'success') {
              alert('Password update successfully...'); // login(email, password);
            }
...
var forgotPassword = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(forgotPasswordEmail) {
    var res;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              alert('Please check your mail. A token sent to your email.'); // login(email, password);
            }
...
// DOM ELEMENTS
var loginForm = document.querySelector('.login_button');
var logoutBtn = document.querySelector('.button_logout');
var signupBtn = document.querySelector('.signup_btn');
var updatePasswordBtn = document.querySelector('.update-pass-btn');
var forgotPasswordBtn = document.querySelector('.forgot-pass-btn'); // const resetPasswordBtn = document.querySelector('.reset-password');
...
if (signupBtn) {
  signupBtn.addEventListener('click', function (e) {
    ...
    (0, _login.signup)(name, email, role, password, confirmPassword);
  });
}

if (updatePasswordBtn) {
  updatePasswordBtn.addEventListener('click', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return (0, _login.updatePassword)({
...
if (forgotPasswordBtn) {
  forgotPasswordBtn.addEventListener('click', /*#__PURE__*/function () {
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              e.preventDefault();
              forgotPasswordEmail = document.getElementById('forgot-password-email').value;
              console.log(forgotPasswordEmail);
              _context2.next = 5;
              return (0, _login.forgotPassword)(forgotPasswordEmail);
...
//         const passwordConfirm = document.getElementById('reset-passwordConfirm').value;
